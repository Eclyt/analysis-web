...
@Component({
    selector: 'app-map-globe-pulsating-bullets',
    templateUrl: './map-globe-pulsating-bullets.component.html',
    styleUrls: ['./map-globe-pulsating-bullets.component.scss']
})
export class MapGlobePulsatingBulletsComponent implements OnInit {
