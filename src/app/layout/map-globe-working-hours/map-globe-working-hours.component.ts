...
@Component({
    selector: 'app-map-globe-working-hours',
    templateUrl: './map-globe-working-hours.component.html',
    styleUrls: ['./map-globe-working-hours.component.scss']
})
export class MapGlobeWorkingHoursComponent implements OnInit {
    ...
    workingHour() {
        ...
        let sunSeries = chart.series.push(am5map.MapPointSeries.new(root, {}));
        ...
        let sunDataItem = sunSeries.pushDataItem({});

        // Create polygon series for night-time polygons
        // https://www.amcharts.com/docs/v5/charts/map-chart/map-polygon-series/
        let nightSeries = chart.series.push(am5map.MapPolygonSeries.new(root, {}));
        ...
        let nightData:any
        let nightDataItem = nightSeries.pushDataItem(nightData);
        ...
        let nineLine = lineSeries.pushDataItem({});
        let fiveLine = lineSeries.pushDataItem({});
        ...
        let ninePoint = pointSeries.pushDataItem({});
        ninePoint.dataContext = {
            labelConfig: { text: "9 AM", fontWeight: "600", centerY: am5.p50 }
        };

        let fivePoint = pointSeries.pushDataItem({});
        ...
        function updateDateNight(time:any) {
            ...
            let nineLongitude = sunPosition.longitude - 15 * 3; // 3 hours from 12 to 9
            let fiveLongitude = sunPosition.longitude + 15 * 5; // 5 hours from 12 to 17
            let max = 89.999;
        ...
        function solarPosition(time:any) {
        ...
        function equationOfTime(centuries:any) {
        ...
        function solarDeclination(centuries:any) {
            return Math.asin(
        ...
        function solarApparentLongitude(centuries:any) {
            return (
        ...
        function solarTrueLongitude(centuries:any) {
            return (
                solarGeometricMeanLongitude(centuries) + solarEquationOfCenter(centuries)
            );
        }

        function solarGeometricMeanAnomaly(centuries:any) {
            return (
        ...
        function solarGeometricMeanLongitude(centuries:any) {
            let l = (280.46646 + centuries * (36000.76983 + centuries * 0.0003032)) % 360;
            return ((l < 0 ? l + 360 : l) / 180) * Math.PI;
        }

        function solarEquationOfCenter(centuries:any) {
        ...
        function obliquityCorrection(centuries:any) {
            return (
        ...
        function meanObliquityOfEcliptic(centuries:any) {
            return (
                (23 +
                    (26 +
                        (21.448 -
        ...
        function eccentricityEarthOrbit(centuries:any) {
