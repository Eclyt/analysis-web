...
@Component({
    selector: 'app-map-globe-rotating-circle',
    templateUrl: './map-globe-rotating-circle.component.html',
    styleUrls: ['./map-globe-rotating-circle.component.scss']
})
export class MapGlobeRotatingCircleComponent implements OnInit {

    constructor() { }

    ngOnInit(): void {
        this.mapRotatingCircle()
    }
