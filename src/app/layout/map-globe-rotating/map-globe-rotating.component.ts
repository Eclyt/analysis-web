...
@Component({
  selector: 'app-map-globe-rotating',
  templateUrl: './map-globe-rotating.component.html',
  styleUrls: ['./map-globe-rotating.component.scss']
})
export class MapGlobeRotatingComponent implements OnInit {
  ...
  rotatingGlobe(){
    ...
    polygonSeries.events.on("inited", function () {
      polygonSeries.mapPolygons.each(function (mapPolygon:any) {
        ...
        let count = data[mapPolygon.id as keyof typeof data];
